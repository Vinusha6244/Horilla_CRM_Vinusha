...
public class ListenerImplimentation implements ITestListener,ISuiteListener{
	...
	public void onStart(ISuite suite) {
		...
		spark.config().setDocumentTitle("Horilla_CRM_Application");
		spark.config().setReportName("Horilla_CRM_Report");
...
//		}
		...
		test.log(Status.FAIL, " ===Failed===> repeat test again"+result.getThrowable());
	}
