...
public class Account extends BaseClass{
	...
	public void  DeleteAccount() throws Throwable
	{
        ...
        Thread.sleep(2000);
        UtilityClassObject.getTest().log(Status.PASS, "Account created successfully and confirmation message displayed Succecfully");
        wlib.takeScreenShot(driver, confirmationMSG);
        peoplePage.getAccountsLink().click();
	    driver.findElement(By.xpath("//div[contains(text(),'"+accountName+"')]/../following-sibling::td[contains(@class,'sticky ')]//img[@alt='Delete']")).click();
	  ...
	  String deteleConfirmationMSG=delete.getText();
        ...
        UtilityClassObject.getTest().log(Status.PASS, "B The record was deleted successfully and confirmation message displayed Succecfully");
